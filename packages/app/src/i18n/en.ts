export const dict = {
  ...
  "provider.custom.models.addProp": "+ Add property",
  "provider.custom.error.number": "Must be a number",
  "provider.custom.models.auto": "Auto",
  "provider.custom.models.auto.tooltip": "Only supported if the API supports /models",
  "provider.custom.models.auto.fetching": "Fetching...",
  "provider.custom.models.auto.empty": "No models returned",
  "provider.custom.models.auto.error": "Could not fetch models",
